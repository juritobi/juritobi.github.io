<!-- section:experience-dacom-informatica -->
...
<!-- section:experience-universidad-de-alicante -->
Here I completed the multimedia engineering degree. This degree gave me the opportunity to work and develop my skills not only in game programming but also in web development. Additionally, I learned the basics of graphic design, 3D modeling and animation, and image and video editing.

<!-- section:experience-julian-kenca -->
...
<!-- section:experience-crunch-games -->
Crunch Games is a collaborative effort between college students, including myself. Here I led the development of three projects: Ratones y Mazmorras, RYM: Alfred's Revenge, and Illyria. Within a team of six, I was mainly in charge of AI programming, movement, and collisions.

<!-- section:experience-vicedo-inmobiliaria -->
...
<!-- section:experience-activawords -->
...
<!-- section:experience-fundamentia -->
...
<!-- section:experience-arkadia-games -->
...
<!-- section:experience-moddo -->
I colaborated in the creation of multi platform app using .NET MAUI

<!-- section:experience-nordcurrent -->
Nordcurrent is a developer and publisher of casual games for smartphones, tablets, and PC/Mac. During my time here, I worked on Airplane Chefs, a free-to-play time management cooking game.

Starting as a junior developer, I was promoted to a mid-level role within four months and entrusted with developing and updating online multiplayer features. My responsibilities also included performance optimizations for our proprietary engine, UI implementation, and core gameplay features.
