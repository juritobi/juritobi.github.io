...
class WouldYouRatherGame {
    ...
    // Initialize the game
    init(playerManager) {
        console.log('Would You Rather game initializing...');
    ...
    async loadQuestions() {
        try {
            ...
            const response = await fetch('./games/would-you-rather/questions.json');
            if (!response.ok) {
    ...
    renderGame() {
        console.log('Rendering Would You Rather game...');
        ...
        const container = document.querySelector('.would-you-rather-container');
...
window.wouldyouratherGame = new WouldYouRatherGame();
