...
class ParanoiaGame {
    ...
    // Initialize the game
    init(playerManager) {
        console.log('Paranoia game initializing...');
    ...
    async loadQuestions() {
        try {
            ...
            const response = await fetch('./games/paranoia/questions.json');
            if (!response.ok) {
    ...
    renderGame() {
        console.log('Rendering Paranoia game...');
        ...
        const container = document.querySelector('.paranoia-container');
...
window.paranoiaGame = new ParanoiaGame();
